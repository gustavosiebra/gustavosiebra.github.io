...
description: Teste para quem esta começando a programar, envolve entrada de dados, laços de repetição e vetor.  # Segundo post
img: helloworld.jpg # Add image post (optional)
---

Um tempo atrás um amigo recém ingresso no curso de Ciências da Computação perguntou se eu sabia programar, o professor dele tinha passado um desafio valendo nota, lembrei do meu início, tive muitas dificuldades e por sorte convivi com pessoas que sempre puderam ajudar, meu primeiro trabalho na faculdade era entrar com número de 1-1000 e exibir na tela por extenso, dificílimo na época. Bom, passando a nostalgia vamos ao desafio do colega e a minha resolução. 
